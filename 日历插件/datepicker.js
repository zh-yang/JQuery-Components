    ...
    DatePicker.prototype = {
      ...
      render: function() {
        var tpl = '<div class="ui-date-picker" style="display:none">'
              +    '<div class="header"><span class="caret-left-year"></span><span class="caret-left-month"></span><span class="cur header-date"></span><span class="caret-right-year"></span><span class="caret-right-month"></span></div>'
              +    '<table class="panel">'
      ...
      bind: function() {
        var self = this;
        this.$datepicker.find('.caret-left-month').on('click', function(){
          self.watchDate = self.getPreMonth(self.watchDate);
          self.setData();
        });
        this.$datepicker.find('.caret-right-month').on('click', function(){
          self.watchDate = self.getNextMonth(self.watchDate);
          self.setData();
        });
        this.$datepicker.find('.caret-left-year').on('click', function(){
          self.watchDate = self.getPreYear(self.watchDate);
          self.setData();
        });
        this.$datepicker.find('.caret-right-year').on('click', function(){
          self.watchDate = self.getNextYear(self.watchDate);
          self.setData();
        });
